        ...
        <div>
            <table class="request-list__table">
                ...
                <tr class="table-row">
                    ...
                    <td class="detail-col"><a class="link-detail"
                        href="/stamp_correction_request/approve/{{ $pendingRequest['id'] }}">詳細</a></td>
                </tr>
                @endforeach
            </table>
        </div>
        ...
        <div>
            <table class="request-list__table">
                ...
                <tr class="table-row">
                    ...
                    <td class="detail-col"><a class="link-detail"
                        href="/stamp_correction_request/approve/{{ $approvedRequest['id'] }}">詳細</a></td>
                </tr>
                @endforeach
            </table>
        </div>
